...
import { Percent, BookOpen, Trophy, FolderOpen, User } from 'lucide-react';
...
const StudentDashboard = () => {
  const { user } = useAuth();
  const student = user?.studentDataId ? getStudentById(user.studentDataId) : undefined;
    ...
    <DashboardLayout title="My Dashboard">
      <div className="max-w-6xl mx-auto">
        <Card className="mb-6">
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-xl font-display font-bold">{user?.name || student.name}</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-6 mb-6">
          <Card>
            <CardHeader className="pb-2"><CardTitle className="text-sm font-display">SGPA per Semester</CardTitle></CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader className="pb-2"><CardTitle className="text-sm font-display">Academic Growth</CardTitle></CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={250}>
          ...
          <Card className="lg:col-span-2">
            <CardHeader className="pb-2"><CardTitle className="text-sm font-display">Projects & Competitions Growth</CardTitle></CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={250}>
        ...
        <Card>
          <CardContent className="p-5">
            <div className="flex items-start gap-3">
              <Badge variant={remark.type === 'success' ? 'default' : remark.type === 'destructive' ? 'destructive' : 'secondary'} className="mt-0.5 shrink-0">Remark</Badge>
